...
export class Store {
  ...
  commit (_type, _payload, _options) {//mutations
  ...
  dispatch (_type, _payload) { //action
...
function resetStoreVM (store, state, hot) {
  ...
  // console.log('wrappedGetters',wrappedGetters)
  const computed = {}
...
function installModule (store, rootState, path, module, hot) {
  ...
  if (!isRoot && !hot) {
    ...
    store._withCommit(() => {
      // console.log('parentState',parentState,'moduleName',moduleName,'module.state',module.state)
